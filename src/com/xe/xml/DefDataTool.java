...
import com.xe.excel.DataSettingTool;
import com.xe.tool.impl.RegixTool;
...
public class DefDataTool {
	 ...
	 *            真实xml路径
	 */
	public static List<Object> loadXml(File file, String right) throws Exception {
	...
	public static String getClassDescrible(Class<?> clazz) throws IllegalAccessException, IllegalArgumentException,
		...
		for (Annotation annotation : clazz.getAnnotations()) {
			if (annotation.annotationType().getName().equals("com.xe.annotation.Describle")) {
				hasDescrible = true;
